...
- Multiple choice questions with three possible answers each
...
After answering the last question, the user will be taken to the results screen. They will see their final score, a message based on their score (0-2 / 3-4 / 5) along with their username. There is also a Play Again button that will take the user back to the first question.